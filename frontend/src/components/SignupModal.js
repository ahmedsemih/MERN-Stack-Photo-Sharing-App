...
import { Typography, Box, Button, TextField, InputAdornment, InputLabel, FormControl, IconButton, OutlinedInput, FormControlLabel, Checkbox } from '@mui/material';
  ...
  return (
    <Box component='form' sx={{backgroundColor:'white', display: 'flex', justifyContent: 'center', boxShadow:'rgba(0, 0, 0, 0.35) 0px 5px 15px', flexDirection: 'column', width: { xs: '100vw', sm: '70vw', md: '50vw', lg: '30vw' } }}>
        ...
        <Typography variant='h2' sx={{m:1,textAlign:'center'}}>Sign Up</Typography>
                ...
                <FormControlLabel control={<Checkbox defaultChecked />} name='agree' label="I agree the Terms of Service and Privacy Policy." />
                    <Button sx={{ mt: 1 }} variant="contained" color="error" type='submit'>
                        Sign Up
                    </Button>
                </Box>
